#!/python3
# Keyboard control for a wheelchair, WASD controls. Space to stop. X to exit. 

# Requires: socketCan, can0 interface, can2RNET
...
if __name__ == "__main__":
    ...
    print("WASD controls. Space to stop. X to exit.")
